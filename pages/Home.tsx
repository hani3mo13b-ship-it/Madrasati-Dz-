...
import { BookOpen, FileText, Video, PenTool, CheckCircle2, GraduationCap, Code } from '../components/Icons';
      ...
      <div className="pt-8 pb-4 text-center">
        <div className="flex items-center justify-center gap-2 mb-1">
            ...
            <p className="text-xs font-bold text-gray-500 tracking-wider">
                Developed by <span className="text-emerald-600 font-black">Hani</span>
            </p>
        </div>
        <p className="text-[10px] text-gray-400 font-medium">جميع الحقوق محفوظة © 2025</p>
      </div>
    </div>
  );
};
