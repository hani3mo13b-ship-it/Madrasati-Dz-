...
const About: React.FC<AboutProps> = ({ onBack }) => {
  return (
    <div className="min-h-screen bg-white pb-20 animate-fade-in">
      ...
      <div className="px-6 pb-6 mt-8 text-center bg-gray-50 pt-8 pb-10 border-t border-gray-100">
         <div className="inline-block p-5 bg-white rounded-2xl shadow-lg border border-emerald-100 mb-4 transform hover:scale-105 transition-transform">
             <Code className="text-emerald-500 mx-auto mb-2" size={24} />
             <p className="text-base text-gray-800 font-black mb-1">Developed by Hani</p>
             <p className="text-xs text-emerald-600 font-bold">Full Stack Developer (13 Years Old)</p>
         </div>
         <p className="text-[10px] text-gray-400 font-bold">جميع الحقوق محفوظة © 2025</p>
      </div>
    </div>
  );
};
